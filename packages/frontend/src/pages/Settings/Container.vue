...
<template>
  ...
  <div v-else class="h-full overflow-y-auto bg-surface-900">
    <div class="mx-auto max-w-7xl px-6 pt-8 pb-2">
      <div class="flex items-center justify-between mb-2">
        <div>
          <h1 class="text-4xl font-bold text-surface-0">Settings</h1>
    ...
    <div class="mx-auto max-w-7xl px-6 pt-2 pb-8">
      ...
      <div class="bg-surface-900/70 border border-surface-800 rounded-2xl p-6">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
          <div>
            <h2 class="text-2xl font-semibold text-surface-0">Webhooks</h2>
